...
/* ./.libs/lt-bluefish.c - temporary wrapper executable for .libs/bluefish.exe
   Generated by libtool (GNU libtool) 2.5.4

   The bluefish program cannot be directly executed until all the libtool
...
const char * EXE_PATH_VALUE   = "C:\\msys64\\mingw64\\lib:C:\\msys64\\mingw64\\bin;";
const char * TARGET_PROGRAM_NAME = "bluefish.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# bluefish - temporary wrapper script for .libs/bluefish.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.5.4\n", f);
  fputs ("#\n", f);
  fputs ("# The bluefish program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"bluefish.exe:bluefish:$LINENO: libtool wrapper (GNU libtool) 2.5.4\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"bluefish.exe:bluefish:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"bluefish.exe:bluefish:$LINENO: newargv[0]: $progdir\\\\$program\" 1", f);
  fputs (">&2\n", f);
  ...
  fputs ("    PATH=C:/msys64/mingw64/lib:C:/msys64/mingw64/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
