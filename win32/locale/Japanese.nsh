...
!define GTK_REQUIRED "バージョン ${GTK_MIN_VERSION} 以上の GTK+ をインストールし、Bluefish を起動する前に PATH が通っていることを確認してください。"

; Python Strings
!define PYTHON_DOWNLOAD	"Python をダウンロードしています..."
!define PYTHON_FAILED	"Python のダウンロードに失敗しました:"
!define PYTHON_INSTALL	"Python をインストールしています..."
!define PYTHON_REQUIRED	"バージョン ${PYTHON_MIN_VERSION} 以上の Pythonをインストールし、Bluefish を起動する前に PATH が通っていることを確認してください。\nPython は Zencoding プラグインと他の機能のために必要です。"
